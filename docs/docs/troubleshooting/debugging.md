...
Advanced debugging techniques for troubleshooting Vulntor.
...
```bash
vulntor scan --targets 192.168.1.100 --log-level debug 2> debug.log
```
...
```bash
vulntor scan --targets 192.168.1.100 --log-format json | jq
```
...
```bash
vulntor scan --targets 192.168.1.100 --trace
```
...
CPU profiling:
```bash
vulntor scan --targets 192.168.1.100 --cpuprofile cpu.prof
go tool pprof cpu.prof
```

Memory profiling:
```bash
vulntor scan --targets 192.168.1.100 --memprofile mem.prof
